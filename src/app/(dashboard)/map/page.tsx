...
const DIVE_SITES = [
  ...
  // ===== 新增12个 =====
  {
    ...
    rating: 4.8,
    image: '🇲🇽',
    description: '著名漂流潜水，珊瑚墙和丰富鱼群，是世界顶级潜水目的地之一',
  },
  {
    id: 46,
    name: '索科罗群岛',
    ...
    rating: 4.9,
    image: '🐋',
    description: '巨型蝠鲼、鲸鲨、海豚和大型远洋生物的天堂，被称为"墨西哥的加拉帕戈斯"',
  },
  {
    id: 47,
    name: '瓜达卢佩岛',
    ...
    rating: 4.8,
    image: '🦈',
    description: '世界著名大白鲨笼潜地点，是观赏大白鲨的最佳地点之一',
  },
  {
    id: 48,
    name: '德兰士瓦沉船（Thistlegorm）',
    location: '埃及, 红海',
    lat: 27.0,
    lng: 34.0,
    rating: 4.9,
    image: '⚓',
    description: '二战沉船，摩托车、卡车等货物仍可见，是红海最著名的沉船潜点',
  },
  {
    id: 49,
    name: '阿波岛',
    ...
    rating: 4.8,
    image: '🐢',
    description: '海龟保护区，珊瑚礁生态非常丰富，是菲律宾最著名的潜水胜地之一',
  },
  {
    id: 50,
    name: '南莱恩环礁',
    ...
    rating: 4.7,
    image: '🦈',
    description: '远洋鲨鱼、鲹鱼和大型海洋生物的聚集地，是太平洋深处的潜水秘境',
  },
  {
    id: 51,
    name: '加德纳湾（伊莎贝拉岛）',
    ...
    rating: 4.8,
    image: '🦎',
    description: '海鬣蜥、海狮等独特加拉帕戈斯生物，是加拉帕戈斯群岛最独特的潜点',
  },
  {
    id: 52,
    name: '汤加鲸鱼潜水区',
    ...
    rating: 4.9,
    image: '🐋',
    description: '座头鲸季节性聚集，可进行鲸类水下观察，是世界上最独特的潜水体验之一',
  },
  {
    id: 53,
    name: '普拉森西亚',
    ...
    rating: 4.7,
    image: '🐋',
    description: '鲸鲨季节、珊瑚礁和丰富热带鱼类，是伯利兹著名的鲸鲨观赏点',
  },
  {
    id: 54,
    name: '德班鲨鱼海岸',
    ...
    rating: 4.7,
    image: '🦈',
    description: '沙虎鲨、黑鳍鲨等大型鲨鱼的聚集地，是南非最著名的鲨鱼潜水点',
  },
  {
    id: 55,
    name: '塞班岛蓝洞',
    ...
    rating: 4.8,
    image: '💎',
    description: '著名洞穴潜水点，蓝色水下洞穴，是塞班岛最著名的潜水目的地',
  },
  {
    id: 56,
    name: '阿里瓦利浅滩',
    ...
    rating: 4.8,
    image: '🦈',
    description: '著名鲨鱼潜水点，可见沙虎鲨等大型鲨鱼，是南非鲨鱼潜水的标志性地点',
  },
];
