    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
        <div className="flex items-center justify-center gap-3 mb-6">
          ...
          <h1 className="text-6xl md:text-7xl font-bold text-white tracking-wide drop-shadow-lg">DivingLog</h1>
        </div>
        <p className="text-xl md:text-2xl text-white/80 mb-8 drop-shadow-md">记录每一次潜水，珍藏每一刻回忆</p>
        {user ? (
          <Link href="/dashboard">
            <button className="bg-white/20 backdrop-blur-md hover:bg-white/30 text-white border border-white/30 px-8 py-6 text-lg rounded-full flex items-center gap-2">
              <Compass className="h-5 w-5" />进入仪表盘
            </button>
          </Link>
        ) : (
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/login">
              <button className="bg-white/20 backdrop-blur-md hover:bg-white/30 text-white border border-white/30 px-8 py-6 text-lg rounded-full flex items-center gap-2">
                <User className="h-5 w-5" />登录
              </button>
            </Link>
            <Link href="/register">
              <button className="bg-white/30 backdrop-blur-md hover:bg-white/40 text-white border border-white/30 px-8 py-6 text-lg rounded-full">注册</button>
            </Link>
          </div>
        )}
